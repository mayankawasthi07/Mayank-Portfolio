    ...
    <section className="pt-32 pb-20 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="font-display text-5xl md:text-6xl font-extrabold text-slate-950 text-center leading-tight max-w-3xl mx-auto mb-6">
          I build fast, modern{' '}
          <span className="text-brand-500">web interfaces</span>
        </h1>

        <p className="text-lg text-slate-500 text-center max-w-xl mx-auto mb-10 leading-relaxed">
          Frontend developer specialising in React and Tailwind. I help startups and businesses turn ideas into clean, responsive, production-ready websites.
        </p>
